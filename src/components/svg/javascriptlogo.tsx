...
const JavaScriptLogo = ({ width = 200, height = 200 }) => {
	return (
		<svg width={width} height={height} viewBox="0 0 630 630" xmlns="http://www.w3.org/2000/svg">
			<defs>
				<linearGradient id="jsGradient" x1="0%" y1="0%" x2="100%" y2="0%">
					<stop offset="0%" stopColor="rgb(251, 139, 36)" />
					<stop offset="100%" stopColor="rgb(233, 220, 201)" />
				</linearGradient>
			</defs>
			<rect width="630" height="630" fill="url(#jsGradient)" />
			<path
