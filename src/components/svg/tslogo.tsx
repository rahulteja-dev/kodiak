...
const TypeScriptLogo = ({ width = 200, height = 200 }) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" width={width} height={height}>
			<title>TypeScript Logo with Gradient</title>
			<defs>
				<linearGradient id="tsGradient" x1="0%" y1="0%" x2="100%" y2="0%">
					<stop offset="0%" stopColor="rgb(251, 139, 36)" />
					<stop offset="100%" stopColor="rgb(233, 220, 201)" />
				</linearGradient>
			</defs>
			<path fill="url(#tsGradient)" d="M0 200V0h400v400H0" />
			<path
				fill="#000"
